...
export class LoginComponent implements OnInit {
  ...
  constructor(private _formBuilder: UntypedFormBuilder, private _http: HttpClient, private _router: Router, private _loginService: LoginService, public _dialog: MatDialog, private _platformLocation: PlatformLocation
  ) { }
